            ...
            <View style={[styles.container, { backgroundColor: theme.background }]}>
                ...
                {plants.length === 0 ? (
                    <View style={styles.noPlantContainer}>
                              ...
                              <TouchableOpacity onPress={() => navigation.navigate('AddPlant', { screen: 'AddPlantHardware', })} style={styles.addButtonBig}>
                                <AppText style={styles.addButtonBigTextTop}>+</AppText>
                                <AppText style={styles.addButtonBigText}>Add a Plant</AppText>
                              </TouchableOpacity>
                            </View>
                ) : (
